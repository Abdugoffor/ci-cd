...
function openDatePicker(param) {
    document.getElementById(param).showPicker();
}

function updateDate(paramId) {
    const dateInput = document.getElementById(paramId);
    const datePlaceholder = document.getElementById(paramId + "Placeholder");
