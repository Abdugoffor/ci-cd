                ...
                <div class="group-additional">
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                          ...
                          <div class="input-wrapper">
                            <label for="national-federation" class="input-label">{{ getTranslation('photo_for_accreditation') }}</label>
    ...
    <script>
      ...
      cropBtn.addEventListener("click", async function () {
        ...
        try {
          ...
          const file = new File([blob], currentFileName || 'photo.png', { type: 'image/png' });
          ...
          fileNameDisplay.textContent = currentFileName.length > 20 ? currentFileName.substring(0, 17) + '...' : currentFileName;
