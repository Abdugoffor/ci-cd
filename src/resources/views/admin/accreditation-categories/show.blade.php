...
@section('content')
    ...
    <div class="content">
        <div class="d-inline-flex gap-2">
            <a href="{{ route('accreditation-categories.index', [], false) }}" class="btn btn-sm btn-outline-success">
                {{ getTranslation('back') }}
            </a>
            <a href="{{ route('accreditation-categories.edit', $model->id, false) }}" class="btn btn-sm btn-outline-success ml-2">
