            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
                        ...
                        <div>
                            <a href="{{ route('faqs.create', [], false) }}" class="btn btn-teal">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('faqs.show', $model->id, false) }}"
                                                    class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>

                                                <a href="{{ route('faqs.edit', $model->id, false) }}"
                                                ...
                                                <div id="modal_full{{ $model->id }}" class="modal fade" tabindex="-1">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('faqs.destroy', $model->id, false) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
