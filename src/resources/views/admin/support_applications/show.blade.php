...
@section('content')
    ...
    <div class="content">
        <div class="d-inline-flex gap-2">
            <a href="{{ route('support-applications.index', [], false) }}" class="btn btn-sm btn-outline-secondary">
                {{ getTranslation('back') }}
            </a>
            <a href="{{ route('support-applications.edit', $model->id, false) }}" class="btn btn-outline-secondary ml-2">
