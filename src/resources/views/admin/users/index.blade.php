                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('users.destroy', $model->id) }}"
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" data-dashlane-label="true">Закрыть</button>
                                                                    <button type="submit" class="btn btn-danger" data-dashlane-label="true">Подтвердить</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
