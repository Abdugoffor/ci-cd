                ...
                <div class="page-header page-header-light">
                    <div class="page-header-content header-elements-lg-inline">
                        <div class="page-title d-flex">
                            <h4>
                                <span class="font-weight-semibold">Home</span> - Dashboard</h4>
                        ...
                        <div class="col-xl-8">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="#" class="dropdown-item"><i
                                                            class="icon-sync"></i> Update data</a>
                                                    <a href="#" class="dropdown-item"><i
                                                            class="icon-list-unordered"></i> Detailed log</a>
                                                    <a href="#" class="dropdown-item"><i
                                                            class="icon-pie5"></i> Statistics</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a href="#" class="dropdown-item"><i
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Facebook</a>
                                                            <div class="text-muted font-size-sm">
                                                                <span
                                                                    class="badge badge-mark border-primary mr-1"></span>
                                                                02:00 - 03:00
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Youtube
                                                                videos</a>
                                                            <div class="text-muted font-size-sm">
                                                                <span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Spotify ads</a>
                                                            <div class="text-muted font-size-sm">
                                                                <span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Twitter ads</a>
                                                            <div class="text-muted font-size-sm">
                                                                <span
                                                                    class="badge badge-mark border-secondary mr-1"></span>
                                                                04:00 - 05:00
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Bing
                                                                campaign</a>
                                                            <div class="text-muted font-size-sm">
                                                                <span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Amazon ads</a>
                                                            <div class="text-muted font-size-sm">
                                                                <span
                                                                    class="badge badge-mark border-danger mr-1"></span>
                                                                18:00 - 19:00
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Dribbble
                                                                ads</a>
                                                            <div class="text-muted font-size-sm">
                                                                <span
                                                                    class="badge badge-mark border-primary mr-1"></span>
                            ...
                            <div class="card">
                                <div class="card-header header-elements-sm-inline">
                                    ...
                                    <div class="header-elements">
                                        <a
                                            class="text-body daterange-ranges font-weight-semibold cursor-pointer dropdown-toggle">
                                ...
                                <div
                                    ...
                                    <div>
                                        <a href="#" class="btn btn-teal"><i
                                                class="icon-statistics mr-2"></i> Report</a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table text-nowrap">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="text-center">
                                                    <div class="list-icons">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a href="#" class="dropdown-item"><i
                                                                        class="icon-undo"></i> Quick reply</a>
                                                                <a href="#" class="dropdown-item"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Chris
                                                                Macintyre</a>
                                                            <div class="text-muted font-size-sm"><span
                                                                    class="badge badge-mark border-primary mr-1"></span>
                                                                Active</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="text-body">
                                                        <div class="font-weight-semibold">[#1184] Round grid column
                                                            gutter operations</div>
                                                    ...
                                                    <div class="list-icons">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <div class="dropdown-divider"></div>
                                                                <a href="#" class="dropdown-item"><i
                                                                        class="icon-plus3 text-primary"></i> Unresolve
                                                                    issue</a>
                                                                <a href="#" class="dropdown-item"><i
                                                                        class="icon-cross2 text-danger"></i> Close
                                                                    issue</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Roxanne
                                                                Forbes</a>
                                                            <div class="text-muted font-size-sm"><span
                                                                    class="badge badge-mark border-success mr-1"></span>
                                                                Resolved</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                class="text-body font-weight-semibold">Mitchell
                                                                Sitkin</a>
                                                            <div class="text-muted font-size-sm"><span
                                                                    class="badge badge-mark border-danger mr-1"></span>
                                                                Closed</div>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="#" class="dropdown-item"><i
                                                                    ...
                                                                    issue</a>
                                                                <a href="#" class="dropdown-item"><i
                                                                        class="icon-spinner11 text-success"></i>
                                                                    Reopen issue</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="media flex-column flex-sm-row mt-0 mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-title"><a href="#">Up unpacked
                                                            friendly</a></h6>
                                                    <ul class="list-inline list-inline-dotted text-muted mb-2">
                                                        <li class="list-inline-item"><i
                                                                class="icon-book-play mr-2"></i> Video tutorials</li>
                                                    </ul>
                                            ...
                                            <div class="media flex-column flex-sm-row mt-0 mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-title"><a href="#">It allowance
                                                            prevailed</a></h6>
                                                    <ul class="list-inline list-inline-dotted text-muted mb-2">
                                                        <li class="list-inline-item"><i
                                                                class="icon-book-play mr-2"></i> Video tutorials</li>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="media flex-column flex-sm-row mt-0 mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-title"><a href="#">Case read they
                                                            must</a></h6>
                                                    <ul class="list-inline list-inline-dotted text-muted mb-2">
                                                        <li class="list-inline-item"><i
                                                                class="icon-book-play mr-2"></i> Video tutorials</li>
                                            ...
                                            <div class="media flex-column flex-sm-row mt-0 mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-title"><a href="#">Too carriage
                                                            attended</a></h6>
                                                    <ul class="list-inline list-inline-dotted text-muted mb-2">
                                                        <li class="list-inline-item"><i
                                                                class="icon-book-play mr-2"></i> FAQ section</li>
                                                    </ul>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="mr-3">
                                                            <a href="#"
                                                                class="btn btn-danger rounded-pill btn-icon btn-sm">
                                                                <span class="letter-icon"></span>
                                                            </a>
                                                        </div>
                                                        <div>
                                                            <a href="#"
                                                                ...
                                                                application</a>
                                                            <div class="text-muted font-size-sm"><i
                                                                    class="icon-spinner11 font-size-sm mr-1"></i>
                                                                Renewal</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                ...
                                                                application</a>
                                                            <div class="text-muted font-size-sm"><i
                                                                    class="icon-lifebuoy font-size-sm mr-1"></i>
                                                                Support</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                                ...
                                                                application</a>
                                                            <div class="text-muted font-size-sm"><i
                                                                    class="icon-spinner11 font-size-sm mr-2"></i>
                                                                Renewal</div>
                                                        </div>
                                                    </div>
                                                </td>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="media-list">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                Stats for July, 6: <span class="font-weight-semibold">1938</span>
                                                orders, <span class="font-weight-semibold text-danger">$4220</span>
                                                revenue
