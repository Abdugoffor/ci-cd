...
#RUN chown www-data:www-data /var/www/laravel/storage/logs/laravel.log
#RUN chmod 664 /var/www/laravel/storage/logs/laravel.log
...
CMD ["sh", "/usr/local/bin/init.sh >> /var/www/laravel/storage/logs/laravel.log 2>&1 &"]